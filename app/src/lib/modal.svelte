<script lang="ts">
  ...
  import vat from "/src/assets/vat.svg";
  import home from "/src/assets/home.svg";
  import tel from "/src/assets/tel.svg";
</script>
    ...
    <div class="modal">
      <div class="contact">
        ...
        <ul class="contact-list">
          <li>
            <img src={home} alt="vat nummer" />
            {company.Address}
          </li>
          <li><img src={tel} alt="vat nummer" /> {company.Tel}</li>
          <li><img src={vat} alt="vat nummer" /> {company.VAT}</li>
        </ul>
      </div>
      <div class="certificate">
        <h2>{company.Name}</h2>
        <div class="cert">
          {#if selectedCertificate.Suspended}
            <svg
              width="22"
              height="21"
              viewBox="0 0 22 21"
          ...
          <FavouriteButton
            ...
            IsFavourite={selectedCertificate.IsFavourite}
          />
        </div>
        <p>{selectedCertificate.Product} :</p>
      </div>
    </div>
  </div>
{/if}
...
<style lang="scss">
  ...
  .modal {
    ...
    position: absolute;
    width: 50%;
    height: auto; /* or specify a fixed height if you prefer */
    top: 50%;
    left: 50%;
