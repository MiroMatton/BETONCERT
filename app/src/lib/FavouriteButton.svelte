<script lang="ts">
    ...
    async function toggleFavourite() {
        ...
        try {
            ...
            const url = `http://localhost:8080/api/certificates/${Id}`;
...
<img src={`src/assets/${IsFavourite ? 'favourite' : 'unFavourite'}.svg`} alt="favourite button" on:click={toggleFavourite} />
